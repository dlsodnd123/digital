...
<body>
	<form action="<%=request.getContextPath()%>" id="form" class="container" method="post">
        ...
        <div class="form-group">
            <input type="password" class="form-control" id="pw2" name="pw2" placeholder="비밀번호확인" value="${user.pw2}">
